...
st.write("#### Persona/s: John Salomon Arisaca Alvarez")
st.write("----")
...
######## Grafico de Antiguedad de clientes ###########
...
figure = go.Figure(data=charts, layout=go.Layout({
    ...
    'title': {'text': 'Grafico de antiguedad de clientes'},
...
figure = go.Figure(data=charts, layout=go.Layout({
    'barmode': 'group',
    'legend': {'orientation': 'h'},
    'title': {'text': 'Grafico limite credito tc'},
